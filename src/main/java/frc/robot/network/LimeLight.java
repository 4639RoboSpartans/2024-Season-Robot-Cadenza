...
public class LimeLight {
  ...
  public static double getXDistance() {
    double rawDistance =
        getOrNaN(Network.getTable("limelight").getDoubleArray("camerapose_targetspace"), 0);
    return rawDistance + ShooterInfo.LimelightOffsetX;
  }

  public static double getYDistance() {
    double rawDistance =
        getOrNaN(Network.getTable("limelight").getDoubleArray("camerapose_targetspace"), 1);
  ...
  public static double getRobotRelativeXDistance() {
    double rawDistance =
        getOrNaN(Network.getTable("limelight").getDoubleArray("targetpose_robotspace"), 0);
    return rawDistance + ShooterInfo.LimelightOffsetX;
  }

  public static double getRobotRelativeYDistance() {
    double rawDistance =
        getOrNaN(Network.getTable("limelight").getDoubleArray("targetpose_robotspace"), 1);
    return rawDistance + ShooterInfo.LimelightOffsetZ;
  }

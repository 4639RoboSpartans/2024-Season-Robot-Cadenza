...
public class AutoHelper {
    ...
    private static ShooterSubsystem shooter = SubsystemManager.getShooter();
    private static ConcreteIntakeSubsystem intake = SubsystemManager.getIntake();
    ...
    public static Command ampPrepCommand() {
        return Commands.parallel(
                        ...
                        Commands.run(() -> intake.setExtended(ConcreteIntakeSubsystem.ExtensionState.EXTENDED))
                )

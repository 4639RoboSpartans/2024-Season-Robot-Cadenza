...
public final class IDs {
  ...
  public static final SwerveModuleConfiguration MODULE_FRONT_LEFT =
      new SwerveModuleConfiguration(
          1, 2, 9, Constants.swerveOffsets[0] // , 0.8
          );
  public static final SwerveModuleConfiguration MODULE_FRONT_RIGHT =
      new SwerveModuleConfiguration(
          3, 4, 10, Constants.swerveOffsets[1] // , 0.5
          );
  public static final SwerveModuleConfiguration MODULE_BACK_LEFT =
      new SwerveModuleConfiguration(
          5, 6, 11, Constants.swerveOffsets[2] // , 0.8
          );
  public static final SwerveModuleConfiguration MODULE_BACK_RIGHT =
      new SwerveModuleConfiguration(

...
public class ModuleIOTalonFX implements ModuleIO {
    ...
    @Override
    public void setDriveVelocity(Rotation2d rotationsPerSecond) {
        final MotionMagicVelocityVoltage m_request = new MotionMagicVelocityVoltage(rotationsPerSecond.getRotations());
        driveTalon.setControl(m_request);
    }
    ...
    @Override
    public void rotate(Rotation2d rotations){
        final MotionMagicVoltage m_request = new MotionMagicVoltage(rotations.getRotations());
        turnTalon.setControl(m_request);
    }
